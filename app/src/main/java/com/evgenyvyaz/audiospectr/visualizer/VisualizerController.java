package com.evgenyvyaz.audiospectr.visualizer;
...
public class VisualizerController {
	...
	private List<VisualizerView> viewsWaves = new ArrayList<VisualizerView>();

	public void addView(VisualizerView v) {
		views.add(v);
	}
	/*public void addViewWaves(VisualizerView v) {
		viewsWaves.add(v);
	}*/
	...
	public void link(MediaPlayer player)
	{
		...
		System.out.println("session = " + player.getAudioSessionId());
